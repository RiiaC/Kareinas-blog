...
---
# Second Try
On Tuesday 2025-12-02 I poked around the documentation a bit, and found the part where it suggested that one could edit the quartz.config.ts file, so I found it using Windows explorer, and edited it in Notepad++. This first attempt I only changed the title of the page to Kareina's Blog. How
# First Try
